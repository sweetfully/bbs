...
def page(total_num, current_num, url_prefix, page_max_num=9):
    ...
    if current_num == 1:
        ...
        page_list.append(
            '<li><a href="{}?page={}" aria-label="Previous"><span aria-hidden="true">首页</span></a></li>'.format(url_prefix, 1)
        )
        page_list.append(
            '<li><a href="{}?page={}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>'.format(url_prefix, current_num-1)
        )
    ...
    if current_num == total_num:
        ...
        page_list.append(
            '<li><a href="{}?page={}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>'.format(url_prefix, total_num)
        )
        page_list.append(
            '<li ><a href="{}?page={}" aria-label="Previous"><span aria-hidden="true">尾页</span></a></li>'.format(url_prefix, total_num)
        )
